...
stats(T); }
public static void stats(int times){ double averageChildren = 0; 
...
double rnd = Math.random(); if (rnd < 0.5) {
numOfBoys++; }
else{ numOFGirls++;
}
totalChildren++; }
...
System.out.println("Number of families with 3 children: " + FamiliesWithThree); System.out.println("Number of families with 4 or more children: " + familiesWithFourOrMore); 
